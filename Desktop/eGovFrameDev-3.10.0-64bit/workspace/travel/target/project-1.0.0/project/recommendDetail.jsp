 ...
 맛집 화면
	...
	<div class = "div2">
		...
		*지역명을 클릭해보세요
		...
		<span style="font-size:18px;">추천 맛집 리스트</span>
		</div>
		...
		<div>
 			...
 			<div style="width:35%;height:200px;float:left;margin-left:30px;margin-top:0px;clear:left;">
		 		<img src = "/images/restaurant/${result.title }1.jpg" style = "width:250px;height:180px;">
		 	</div>
		 	
 			<div style="width:80px;height:50px;float:left;margin-left:-10px;margin-top:0px;">
		 		<img src = "/images/restaurant/${result.title }1.jpg" style = "width:80px;height:50px;">
		 	</div>
		 	
		 	<div style="width:80px;height:50px;float:left;margin-left:-80px;margin-top:65px;">
		 		<img src = "/images/restaurant/${result.title }2.jpg" style = "width:80px;height:50px;">
		 	</div>
		 	
		 	<div style="width:80px;height:50px;float:left;margin-left:-80px;margin-top:130px;">
		 		<img src = "/images/restaurant/${result.title }3.jpg" style = "width:80px;height:50px;">
		 	</div>
			...
			<div style="width:300px;height:180px;float:left;margin-left:80px;margin-top:0px;text-align:left;">
 				...
 				<p style="font-size:12px;">평점 : ${result.grade2 }점</p>
 			</div>
	 	...
	 	<div style = "margin-top:5px;text-align:center;margin-top:30px;font-size:15px;padding:20px;clear:left;">
 			...
 			if (page_sno-1 > 0) {
 			%>
 				<a href = "recommendDetail.do?page_no=${page_sno-1 }">이전</a>
 			<%
 			}
 			%>
			...
			<c:forEach var="i" begin="${vo.page_sno }" end="${page_eno }">
				<a href = "recommendDetail.do?page_no=${i }">${i }</a>
			</c:forEach>
			<%
			if (page_eno+1 < total_page) {
			%>
				<a href = "recommendDetail.do?page_no=${vo.page_eno+1 }">다음</a>
			<%
			}
			%>
		</div>
