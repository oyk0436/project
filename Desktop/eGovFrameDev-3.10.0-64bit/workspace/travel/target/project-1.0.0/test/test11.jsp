...
div.header {
	display:table;position:relative;width:600px;height:30px;left:50px;top:30px;border:0px solid #ccc;margin-top:-30px;
}
div.row1 {
...
div.body1 {
	display:table;position:relative;width:600px;left:50px;top:30px;
}
div.cell1_1 {
...
<script>
	...
	function fn_area(n) {
		location = "restaurant.do?area="+ encodeURI(n , "UTF-8"); // get 방식 한글깨짐 방지
	}
	...
	$(function() {
	    ...
	    $("#area").change(function() {
	        ...
	        $.ajax({
				type : "post",
				data : area,
				url : "/project/covid.jsp?area="+area,
				dataType : "text",
...
<div style="width:600px;height:300px;">
	...
	<div class = "header">		
		<div class = "row1">			
			<div style = "display:table-cell;font-size:20px;font-weight:bold;padding:7px;">
				<span style="font-size:24px;color:purple;"><%=areaFullName %> COVID-19</span> ${area }확진자 현황
			</div>		
	...
	<!-- footer -->
	<div class = "footer" style = "position:relative;margin-top:-10px;">			
