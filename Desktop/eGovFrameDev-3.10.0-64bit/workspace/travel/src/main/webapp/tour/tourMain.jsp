	...
	<div class = "div2">
		...
		*지역명을 클릭해보세요
		...
		<div style="width:90%;
		  			...
		  			padding:10px;
		  			clear:left;">
			<span style="font-size:18px;color:#ff6666;">${vo.s_text }${vo.regionDetail }</span> <span style="font-size:18px;">추천 관광지</span> <br>
			
			<div style="float:right;">
				<a href = "tRecommendDetail.do">더보기</a>
			</div>
		...
		<div>
			<div style="display:table;position:relative;width:800px;margin:0 auto;top:20px;">
		 		<div style="display:table-row;text-align:center;margin-bottom:10px;background:#ffffcc;">
					...
					<div class="cell1" style="width:30%;border:none;text-align:left;">상호</div>
	 	...
	 	<div style = "margin-top:5px;text-align:center;margin-top:30px;font-size:15px;padding:20px;">
 			...
 			if (page_sno-1 > 0) {
 			%>
 				<a href = "tourMain.do?page_no=${page_sno-1 }">이전</a>
 			<%
 			}
 			%>
			...
			%>
				<a href = "tourMain.do?page_no=${vo.page_eno+1 }">다음</a>
			<%
			}
			%>
		</div>
