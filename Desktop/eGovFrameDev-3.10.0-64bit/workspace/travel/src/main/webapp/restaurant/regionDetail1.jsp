...
%>
	...
	<ul>
		<li><a href="restaurantMain.do?regionDetail=제주시">제주시</a></li>
		<li><a href="restaurantMain.do?regionDetail=서귀포시">서귀포시</a></li>
	</ul>
<%
} else {
%>
	<div style="font-size:24px;text-align:left;"><span style="color:#9966ff;"><%=region %></span> 맛집 찾기</div>
	<ul>
		<li><a href="restaurantMain.do?regionDetail=<%=region %>"><%=region %></a></li>
	</ul>
<%
}
%>
