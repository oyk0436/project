...
%>  
    ...
    <ul class="ul1">
        ...
        <li><a href="#">숙박</a></li>
        <li><a href="restaurantMain.do">음식점</a></li>
        <li><a href="tourMain.do">관광지</a></li>
    </ul>
    <ul class="ul2">
    ...
    %>
        ...
        <li><a href="/travel/memberWrite.do">회원가입</a></li>
        <li style="font-weight:bold"><a href="/travel/loginWrite.do">로그인</a></li>
	<%
    } else { // 세션 아이디 존재
	%>
        <li style="font-weight:bold"><a href="javascript:fn_logout()">로그아웃</a></li>
		<li><a href="/travel/memberInfo.do">마이페이지</a></li>
	<%
    }
	%>       
